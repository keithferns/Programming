...
#import "CalendarViewController_2.h"
...
@implementation CalendarViewController_2
...
- (void)viewDidLoad {
    ...
    /*-------------------*/
    //TABLEVIEWCONTROLLER
    tableViewController = [[AppointmentsTableViewController alloc] init]; //init the tableViewController to appropriateTableView
