...
- (void)viewDidLoad {
    ...
    CustomTextView *tempTextView = [[CustomTextView alloc] initWithFrame:CGRectMake(5, 30, 310, 135)];
    ...
    [folderTextField setFrame:CGRectMake(5, 160, 310, 30)];
...
//FIXME: check to see if a folder with the specified name exists, if yes, put up an alert view 
    ...
    newFolder.name = folderTextField.text;
    newMemo.folder = newFolder;
    /*
